...
class PLGoogle(SR0WXLanguage):
    ...
    def read_decimal(self, value):
        deg1000 = [u("tysie_czna"), u("tysie_czne"), u("tysie_cznych")]
...
wwo_weather_codes = {
    ...
    "185": _(
        ra(u("lokalna przelotna marznąca mżawka"))
    ...
    "314": _(
        ra(u("umiarkowane opady marznącego deszczu"))
    ),  # Moderate or Heavy freezing rain
    "317": _(ra(u("słabe opady śniegu z deszczem"))),  # Light sleet
    "320": _(
        ra(u("umiarkowane lub ciężkie opady śniegu z deszczem"))
    ...
    "365": _(
        ra(u("umiarkowane opady śniegu z deszczem"))
    ...
    "377": _(
        ra(u("umiarkowane opady śniegu ziarnistego"))
