...
class OpenWeatherSq9atk(SR0WXModule):
    ...
    def get_data(self):
        ...
        weather_service_url = self.__service_url + 'weather?lat=' + str(self.__lat) + '&lon=' + str(
            self.__lon) + '&units=metric&appid=' + self.__api_key
        ...
        forecast_service_url = self.__service_url + 'forecast?lat=' + str(self.__lat) + '&lon=' + str(
            self.__lon) + '&units=metric&appid=' + self.__api_key
