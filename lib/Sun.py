...
class Sun:
    ...
    def equation_of_time(self, year, month, day, latitude):
        ...
        fEot = (
            ...
            - 7.343 * math.sin(fA)
            + 0.5519 * math.cos(fA)
            - 9.47 * math.sin(2.0 * fA)
            - 3.02 * math.cos(2.0 * fA)
            - 0.3289 * math.sin(3.0 * fA)
            - 0.07581 * math.cos(3.0 * fA)
            - 0.1935 * math.sin(4.0 * fA)
            - 0.1245 * math.cos(4.0 * fA)
        )
    ...
    def __Solcons(self, dAlf):
        ...
        dVar = (
            ...
            / (
                1.0
                - 9.464e-4 * math.sin(dAlf)
                - 0.01671 * math.cos(dAlf)
                - +1.489e-4 * math.cos(2.0 * dAlf)
                - 2.917e-5 * math.sin(3.0 * dAlf)
                - +3.438e-4 * math.cos(4.0 * dAlf)
            )
            ** 2
        )
        return dVar
