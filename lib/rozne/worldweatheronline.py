...
def getData(lang_module):
    ...
    data = {
        "OBSERVATION_TIME": lang.readISODT(
            utc_dt.astimezone(local).strftime("%Y-%m-%d %H:%M:%S")
        ),
        ...
        "FCAST0_WIND_SPEED_MPS": lang.cardinal(
        ...
        "FCAST1_WIND_SPEED_MPS": lang.cardinal(
            kmph2mps(int(f1["windspeedKmph"])), lang.mPs
        ),
